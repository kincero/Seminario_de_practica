...
--
-- Table structure for table `disponibilidad_basica`
--

DROP TABLE IF EXISTS `disponibilidad_basica`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `disponibilidad_basica` (
  `id_disponibilidad` int NOT NULL AUTO_INCREMENT,
  `id_profesional` int NOT NULL,
  `hora_desde` int NOT NULL,
  `minuto_desde` int NOT NULL,
  `hora_hasta` int NOT NULL,
  `minuto_hasta` int NOT NULL,
